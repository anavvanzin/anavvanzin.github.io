...
const { FolderIcon, DocIcon, MailIcon, GroupIcon, ImageIcon, SealIcon, QuoteIcon, CloseBox } = window;
const { WSobre, WTese, WPublicacoes, WIus, WContato, WJustitia, WCv } = window;
...
const REG = {
  ...
  sala:        { title: { pt: 'sala de leitura', en: 'reading room' }, w: 860, Body: WSalaLeitura },
};
...
const DESK_ICONS = [
  ...
  { id: 'sala', label: { pt: 'sala', en: 'room' }, Icon: FolderIcon },

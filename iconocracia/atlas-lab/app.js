...
(function () {
  ...
  const loadNote = k => {
    try {
      return localStorage.getItem(NOTE_PREFIX + k) || "";
    } catch (e) {
      return "";
    }
  };
  const saveNote = (k, v) => {
    try {
      localStorage.setItem(NOTE_PREFIX + k, v);
    } catch (e) {}
  };
  ...
  const IcoEye = /*#__PURE__*/React.createElement(Glyph, {
  ...
  const IcoLayers = /*#__PURE__*/React.createElement(Glyph, {
    d: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  ...
  function Plate({
    ...
    return /*#__PURE__*/React.createElement("figure", {
      ...
      style: {
        ...
        boxShadow: selected ? "0 0 0 3px rgba(138,95,168,.22)" : "var(--shadow-plate)",
        transition: "box-shadow .15s, border-color .15s"
      }
    }, !bad ? /*#__PURE__*/React.createElement("img", {
      src: it.img,
      alt: it.title,
      loading: "lazy",
      onError: () => setBad(true),
    ...
    }, IcoLayers), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-display)",
        fontStyle: "italic",
        fontSize: 15,
  ...
  function IndicatorBars({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, compact ? ind.id : ind.label), /*#__PURE__*/React.createElement("div", {
        style: {
          flex: 1,
          height: 6,
  ...
  function Radar({
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      role: "img",
      "aria-label": "Radar comparativo dos dez indicadores iconom\xE9tricos entre as duas figuras selecionadas"
    }, [1, 2, 3].map(ring => /*#__PURE__*/React.createElement("polygon", {
      key: ring,
      ...
      fill: `color-mix(in srgb, ${s.color} ${si ? 10 : 18}%, transparent)`,
      stroke: s.color,
      strokeWidth: "2",
      strokeDasharray: si ? "5 3" : "none"
  ...
  const STEPS = [{
    ...
    n: "01",
    label: "Descrever",
    prompt: "Antes de interpretar: descreva o que vê. Corpo, vestes, atributos, enquadramento, inscrições. Só o visível."
  }, {
    k: "comparar",
    n: "02",
    label: "Comparar",
    prompt: "Coloque a peça-guia ao lado da comparação. O que se repete entre as duas? O que muda? Onde o corpo endurece?"
  }, {
    k: "hipotese",
    n: "03",
    label: "Hipótese",
    prompt: "Arrisque uma leitura. Que função do Estado este corpo executa — e a quem ela serve?"
  }];
  ...
  function gatherNotes() {
    ...
    L.panels.forEach(p => {
      const stepNotes = STEPS.map(s => ({
        label: s.label,
        text: loadNote(p.id + "." + s.k)
      })).filter(x => x.text.trim());
      const research = loadNote(p.id + ".research");
      if (stepNotes.length || research.trim()) out.push({
        panel: p,
        stepNotes,
        research
      });
  ...
  function downloadNotes() {
    ...
    if (!data.length) {
      md += "_(Nenhuma anotação registrada ainda.)_\n";
    }
    data.forEach(d => {
      md += "## " + d.panel.label + "\n\n";
      if (d.panel.summary) md += "> " + d.panel.summary + "\n\n";
      d.stepNotes.forEach(s => {
        md += "**" + s.label + "** — " + s.text + "\n\n";
      });
    ...
    a.href = url;
    a.download = "atlas-lab-caderno.md";
  ...
  function LearningView({
    ...
    useEffect(() => {
      const init = {};
      STEPS.forEach(s => {
        init[s.k] = loadNote(panel.id + "." + s.k);
      });
      setNotes(init);
      setStep(0);
    }, [panel.id]);
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, "Pe\xE7a-guia"), /*#__PURE__*/React.createElement(Plate, {
      it: hero,
      h: stack ? 260 : 320
    })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Compara\xE7\xE3o"), /*#__PURE__*/React.createElement(Plate, {
      it: comp,
      h: stack ? 260 : 320
    }))), /*#__PURE__*/React.createElement("div", {
      style: {
      ...
      const active = i === step,
        filled = (notes[s.k] || "").trim().length > 0;
      return /*#__PURE__*/React.createElement("button", {
        ...
        style: {
          ...
          borderRadius: "50%",
          flexShrink: 0,
          background: filled ? "var(--brand-amethyst)" : "transparent",
          border: `1.5px solid ${filled ? "var(--brand-amethyst)" : "var(--light-border)"}`,
          boxShadow: active ? "0 0 0 3px rgba(138,95,168,.18)" : "none"
        }
      }), /*#__PURE__*/React.createElement("span", {
        style: {
          fontFamily: "var(--font-mono)",
      ...
      value: notes[STEPS[step].k] || "",
      onChange: e => setNote(STEPS[step].k, e.target.value),
      placeholder: "Escreva sua leitura\u2026",
      rows: 4,
      "aria-label": "Anotação da etapa " + STEPS[step].label,
      style: {
        width: "100%",
    ...
    }, "Iconometria \xB7 pe\xE7a-guia vs compara\xE7\xE3o"), /*#__PURE__*/React.createElement(Radar, {
      series: [{
        scores: hero.indicators,
        color: reg(hero.regime).color,
        label: hero.title
      }, {
        scores: comp.indicators,
        color: reg(comp.regime).color,
        label: comp.title
      }],
      size: 260
    }))), /*#__PURE__*/React.createElement("div", {
  ...
  function ResearchView({
    ...
    const setResearchNote = v => {
      setRnote(v);
      saveNote(panel.id + ".research", v);
    };
    const A = entry(sel[0]),
      B = entry(sel[1]);
    ...
    const middle = /*#__PURE__*/React.createElement("div", {
      ...
      series: [{
        scores: A.indicators,
        color: reg(A.regime).color
      }, {
        scores: B.indicators,
        color: reg(B.regime).color
      }],
      size: stack ? 280 : 300
    }), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Pergunta-guia"), /*#__PURE__*/React.createElement("p", {
      style: {
        fontFamily: "var(--font-display)",
        fontStyle: "italic",
        fontSize: 16,
    ...
    }, "Nota de pesquisa \xB7 salva localmente"), /*#__PURE__*/React.createElement("textarea", {
      value: rnote,
      onChange: e => setResearchNote(e.target.value),
      placeholder: "Registre a codifica\xE7\xE3o, a diverg\xEAncia entre as duas figuras, a interpreta\xE7\xE3o\u2026",
      rows: 4,
      "aria-label": "Nota de pesquisa",
      style: {
        width: "100%",
        boxSizing: "border-box",
        resize: "vertical",
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, "Entradas do painel \xB7 selecione duas"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
    ...
    }, ids.map(id => /*#__PURE__*/React.createElement(Plate, {
      key: id,
      it: entry(id),
      h: 150,
      onClick: () => toggle(id),
      ...
      style: {
        display: "grid",
        gridTemplateColumns: vw < 560 ? "1fr" : "1fr 1fr",
        gap: 18
      }
    }, /*#__PURE__*/React.createElement(CompareCol, {
      it: A
    }), /*#__PURE__*/React.createElement(CompareCol, {
      it: B
    }))) : /*#__PURE__*/React.createElement("div", {
      ...
      it: A,
      align: "left"
    }), middle, /*#__PURE__*/React.createElement(CompareCol, {
      it: B,
      align: "right"
    })));
  }
  function CompareCol({
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Plate, {
      it: it,
      h: 240
    }), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, /*#__PURE__*/React.createElement(RegimeBadge, {
      id: it.regime
    })), /*#__PURE__*/React.createElement(IndicatorBars, {
      it: it
  ...
  function App() {
    ...
    useEffect(() => {
      const ps = L.panels.filter(p => p.modes.includes(mode));
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        background: "var(--cabinet-grad)",
        borderBottom: "1px solid var(--hairline-dark)",
        padding: tight ? "13px 18px" : "16px 32px",
        display: "flex",
        alignItems: "center",
        gap: 14,
        flexWrap: "wrap"
      ...
      "aria-label": "Voltar para anavanzin.com",
      style: {
        display: "flex",
        alignItems: "center",
        gap: 6,
    ...
    })), tight ? "" : "anavanzin.com"), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 1,
        height: 18,
    ...
    }, "Atlas Lab \xB7 v1")), /*#__PURE__*/React.createElement("div", {
      style: {
        marginLeft: "auto",
        display: "flex",
        alignItems: "center",
      ...
      title: "Baixar todas as anota\xE7\xF5es em Markdown",
      "aria-label": "Exportar caderno de anota\xE7\xF5es em Markdown",
      style: {
        display: "flex",
        alignItems: "center",
        gap: 7,
    ...
    }, nNotes) : null), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        border: "1px solid var(--hairline-dark)",
        borderRadius: 999,
    ...
    }, [["learning", "Aprendizagem"], ["research", "Pesquisa"]].map(([m, lbl]) => /*#__PURE__*/React.createElement("button", {
      key: m,
      onClick: () => setMode(m),
      "aria-label": lbl,
      "aria-pressed": mode === m,
      style: {
        ...
        alignItems: "center",
        gap: 7,
        padding: tight ? "8px 12px" : "8px 16px",
        cursor: "pointer",
        border: "none",
    ...
    }, m === "learning" ? IcoEye : IcoLayers, tight ? "" : lbl))))), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: tight ? "10px 18px" : "10px 32px",
        background: "color-mix(in srgb, var(--deep-blue) 6%, transparent)",
    ...
    React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        gap: 8,
        overflowX: "auto",
        padding: tight ? "12px 18px" : "14px 32px",
        background: "var(--cabinet-grad)",
        borderBottom: "1px solid var(--hairline-dark)",
      ...
      style: {
        ...
        cursor: "pointer",
        borderRadius: 999,
        border: `1px solid ${active ? "var(--plumb-node)" : "var(--hairline-dark)"}`,
        background: active ? "rgba(138,95,168,.16)" : "transparent"
      }
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        width: 11,
        ...
        borderRadius: "50%",
        flexShrink: 0,
        background: active ? "var(--plumb-node)" : "transparent",
        border: `1.5px solid ${active ? "var(--plumb-node)" : "var(--hairline-dark)"}`
      }
    }), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-mono)",
    ...
    }, reg(p.regime || "2").roman), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-display)",
        fontStyle: "italic",
        fontSize: 15,
    ...
    React.createElement("div", {
    ...
    }, L.modules.iconocracy.shortName, " \xB7 pain\xE9is"), railItems.map(({
      p,
      active,
      r
    }) => /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        cursor: "pointer",
        border: "none",
        background: active ? "rgba(232,220,196,.06)" : "transparent"
      }
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        width: 14,
        ...
        background: active ? "var(--plumb-node)" : "transparent",
        border: `1.5px solid ${active ? "var(--plumb-node)" : "var(--hairline-dark)"}`,
        boxShadow: active ? "0 0 0 3px var(--plumb-halo)" : "none"
      }
    }), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-mono)",
    ...
    }, p.focusArea && p.regime ? reg(p.regime).roman : "·"), /*#__PURE__*/React.createElement("span", {
      style: {
        flex: 1,
        fontFamily: "var(--font-display)",
        fontStyle: "italic",
    ...
    }, mode === "learning" ? "Observe · descreva · compare · hipótese" : "Observe · codifique · interprete"))), /*#__PURE__*/React.createElement(PanelMain, {
      panel: panel,
      mode: mode,
      tight: tight
    })));
  ...
  function PanelMain({
    ...
    return /*#__PURE__*/React.createElement("main", {
      style: {
        padding: tight ? "20px 18px 56px" : "26px 32px 60px"
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(RegimeBadge, {
      id: panel.regime || "2"
    }), /*#__PURE__*/React.createElement("h1", {
      style: {
        fontFamily: "var(--font-display)",
        fontStyle: "italic",
        fontSize: tight ? 25 : 30,
        color: "var(--ink)",
        margin: "8px 0 4px"
      }
    }, panel.label), /*#__PURE__*/React.createElement("p", {
      style: {
        fontFamily: "var(--font-body)",
        fontSize: 14.5,
        lineHeight: 1.6,
    ...
    }, panel.summary)), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-mono)",
        fontSize: 9,
        letterSpacing: "1.5px",
    ...
    }, mode === "learning" ? "Modo Aprendizagem" : "Modo Pesquisa")), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }), mode === "learning" ? /*#__PURE__*/React.createElement(LearningView, {
      panel: panel
    }) : /*#__PURE__*/React.createElement(ResearchView, {
      panel: panel
    }));
  }

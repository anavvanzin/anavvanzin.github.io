...
> Kept as the requirements baseline that `TEST_INFRA.md` traces to (§R1–R4).
> R2's palette is pre-rebrand and superseded by Mnemosyne Viva — see CLAUDE.md
> for the canonical tokens.

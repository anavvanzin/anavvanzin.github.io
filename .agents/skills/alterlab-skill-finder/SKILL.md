...
5. **EXECUTE.** Run it as a multi-agent workflow — spawn subagents via the host's Task/Workflow tools
   where available (Codex, Cowork); on surfaces without them, execute the phases sequentially and
